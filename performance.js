const PERFORMANCE_QUESTIONS = [
  ...
  {
    question:
      "2. The indicated air speed for the best rate of climb when climbing to cruise altitude will tend to:",
    answers: [
      "Decrease.",
  ...
  {
    question:
      "3. If the stalling speed in the landing configuration is 55 knots. Vref would be approximately:",
    answers: ["71kt.", "65kt.", "75kt.", "69 kt."],
    correct: 0,
  },
  {
    question:
      "4. The Vref to be attained by the landing screen height of 50ft must be:",
    answers: [
  ...
  {
    question:
      "5. If the aircraft mass is increased by 15%, the landing distance required will increase approximately:",
    answers: [
  ...
  {
    question:
      "8. Increasing the aeroplane's gross weight will have what effect on the take-off?",
    answers: [
  ...
  {
    question:
      "10. When the density of the atmosphere is relatively low, the resulting reduction in:",
    answers: [
  ...
  {
    question:
      "11. If the density of the air is increased above ISA conditions, the effect will be:",
    answers: [
  ...
  {
    question:
      "12. The easiest way to determine the pressure altitude is setting an altimeter to.",
    answers: [
  ...
  {
    question:
      "13. Which of the statements below, concerning take-off performance of a powered aircraft regarding the density altitude is correct? At higher density altitudes.",
    answers: [
  ...
  {
    question:
      "15. When landing, if an aircraft's true air speed is significantly less than the true ground speed then the aircraft is experiencing:",
    answers: [
      "A tailwind.",
      "A headwind.",
  ...
  {
    question:
      "16. Which of the factors below increases the density altitude of an airport?",
    answers: [
  ...
  {
    question:
      "17. Under what condition is indicated altitude the same as true altitude?",
    answers: [
  ...
  {
    question:
      "18. If the outside air temperature (OAT) at a given altitude is lower than standard, the density altitude is.",
    answers: [
  ...
  {
    question:
      "20. If the density of the atmosphere is reduced, the take-off distance will be:",
    answers: ["Increased.", "Decreased.", "Unaffected.", "Controlled by wind."],
    correct: 0,
  },
  {
    question:
      "21. That part of a runway surface which is used for normal operations during take-off, excluding any clearway or stopway, is referred to as:",
    answers: [
  ...
  {
    question:
      "23. What effect will a higher aircraft mass have on rotate speed and take-off safety speed?",
    answers: [
  ...
  {
    question:
      "24. When calculating the MZFM (maximum zero fuel mass), the following are included:",
    answers: [
  ...
  {
    question:
      "25. The Centre of Gravity range of most aircraft reduces as the aircraft mass increases, as a result of:",
    answers: [
  ...
  {
    question:
      "26. To gain the greatest amount of height in the shortest time period the aircraft should be flown at:",
    answers: [
  ...
  {
    question:
      "27. Basic reason for calculating the density altitude is determining.",
    answers: [
  ...
  {
    question:
      "28. What is the effect of a headwind on the glide angle and glide distance?",
    answers: [
  ...
  {
    question:
      "30. Increasing the mass (and, therefore, weight) of the aircraft will:",
    answers: [
  ...
  {
    question:
      "32. Compared to landing on a level runway, what would be the effect of landing on a downward sloping runway?",
    answers: [
  ...
  {
    question:
      "33. The lift produced by the wing of an aeroplane that is climbing and maintaining a constant airspeed will be:",
    answers: [
      "Greater than weight.",
      "Less than weight.",
      "Equal to weight.",
  ...
  {
    question:
      "34. What is the reason for increasing the speed in a prolonged climb:",
    answers: [
  ...
  {
    question:
      "37. What speed should be flown for maximum range: (See fig. PPL FPP-10e).",
    answers: ["B.", "A.", "C.", "D."],
    correct: 0,
  },
  {
    question:
      "38. What is the maximum range speed for a piston engine aircraft?",
    answers: [
      "Vmd.",
      "VMP.",
  ...
  {
    question:
      "39. In order to maximise the glide range, the aircraft should be flown:",
    answers: [
  ...
  {
    question:
      "40. What effect would a 2% downslope have on the landing distance required?",
    answers: [
      "Increase it by 10%.",
      "Increase it by 5%.",
      "Decrease it by 5%.",
  ...
  {
    question:
      "41. Which of the following cases will result in a reduced performance and possibly exceed the structural limitations of the aircraft?",
    answers: [
  ...
  {
    question:
      "42. If the approach and landing speed is higher recommended speed in the aircraft manual the effect will be that:",
    answers: [
      "The landing distance will be increased.",
      "The landing distance will be decreased.",
      "The landing performance will improve.",
  ...
  {
    question:
      "43. What speed must be flown to attain the maximum cruise endurance?",
    answers: ["VMP.", "Vy.", "Maximum speed.", "Vmd."],
    correct: 0,
  },
  {
  ...
  {
    question:
      "47. When gliding for maximum range, an aircraft with a greater weight will:",
    answers: [
  ...
  {
    question:
      "48. What speed must be flown to attain the maximum cruise range?",
    answers: ["Vmd.", "Vx.", "Maximum speed.", "Vmp."],
    correct: 0,
  },
  {
    question:
      "49. What would be the effect of an increase in temperature upon the air density and aircraft performance?",
    answers: [
  ...
  {
    question:
      "50. Compared to gliding in still air, the effect of a tailwind will:",
    answers: [
  ...
  {
    question:
      "51. Which of the speeds indicated by A, B, C or D should be flown for maximum endurance? (See fig. PPL FPP-10e).",
    answers: ["A.", "B.", "C.", "D."],
    correct: 0,
  },
  {
    question:
      "52. During straight and level flight, any increase in lift causing an imbalance in the equilibrium of forces is compensated for by:",
    answers: [
  ...
  {
    question:
      "53. What is the effect of an increase in mass on the staii speed and landing distance required?",
    answers: [
  ...
  {
    question:
      "54. How does higher air humidity affect aircraft take-off performance? Take-off distances are.",
    answers: [
  ...
  {
    question:
      "55. A pilot wishes to fly at a speed which will give him maximum range. He knows that he is flying with a tailwind. How will the speed selected by the pilot compare with the maximum range speed for still air?",
    answers: [
  ...
  {
    question:
      "56. What should be done first, following an aircraft's engine failure in flight?",
    answers: [
  ...
  {
    question:
      "57. The density altitude could be approximately calculated from the pressure altitude without using a navigation calculator by.",
    answers: [
  ...
  {
    question:
      "58. You plan to carry your aircraft's maximum permissible 'Traffic Load'. Your principal consideration during your flight planning will be that:",
    answers: [
  ...
  {
    question:
      "59. An aircraft weighing 2000 lbs with a total CG moment of + 169400 lb in uplifts 440 lbs of fuel. If the effective arm of the fuel is 88.5 inches aft of the datum, what will be the aircraft's new mass and CG moment?",
    answers: [
  ...
  {
    question:
      "60. The flight characteristics of an aircraft which has its CG at the forward limit will be:",
    answers: [
  ...
  {
    question:
      "61. An aircraft loaded in a dangerous manner, so that its CG is beyond its forward limit will:",
    answers: [
  ...
  {
    question:
      "63. The Maximum Take-off Mass of an aircraft may be limited by:-.",
    answers: [
  ...
  {
    question:
      "64. Certification requirements stipulate that when loading a light aircraft:",
    answers: [
  ...
  {
    question:
      "65. An aircraft is loaded such that its C of G is on the aft limit:- I The stalling speed decreases, which is a negative factor. II Range and endurance decrease, which are negative factors. III The stall risk increases, which is a negative factor. IV Stick forces increase, which is a negative factor.",
    answers: [
  ...
  {
    question:
      "66. Assuming the aircraft is at rest on the ground, what term best describes image 'D'? (See fig. PPL FPP-2).",
    answers: [
      "Maximum All Up Mass.",
      "Zero Fuel Mass.",
      "Traffic Load.",
  ...
  {
    question:
      "69. The forward speed for minimum rate of descent of an aircraft, compared with its best glide speed, is.",
    answers: [
      "always lower.",
      "always higher.",
      "often higher.",
  ...
  {
    question:
      "70. Assuming the aircraft is at rest on the ground, what term best describes image A'? (See fig. PPL FPP-2).",
    answers: [
      "Zero Fuel Mass.",
      "Take Off Mass.",
      "Maximum All Up Mass.",
  ...
  {
    question:
      "71. An aircraft without an engine will fly the longest distance from a given altitude at the angle of attack at which.",
    answers: [
  ...
  {
    question:
      "73. What is the main danger arising out of even a slight amount of frost or snow on the wings and controls of an aircraft?",
    answers: [
  ...
  {
    question:
      "74. When flying in very rough air what is the maximum speed to be adopted in order to avoid overstressing the airframe?",
    answers: ["Vra or VA.", "VD or VNO.", "VNO or VFE.", "VD or VA."],
    correct: 0,
  },
  {
    question:
      "75. Never exceed speed (VNE) is the red radial line on the ASI and marks the speed at which:",
    answers: [
  ...
  {
    question:
      "76. Which of the following situations may, under certain conditions, result in structural damage occurring?",
    answers: [
  ...
  {
    question:
      "5. Have a reduced rate of climb and operating ceiling. Which of the above are correct?",
    answers: ["1, 2, 3, & 5.", "1, 2, 4 & 5.", "2, 4 & 5.", "1, 2, 3 & 4."],
    correct: 0,
  },
  {
    question:
      "80. What name is given to the load at which the aircraft structure will fail?",
    answers: [
      "Ultimate Load.",
      "Safety Factor Load.",
      "Limit Load.",
  ...
  {
    question:
      "81. What is the colour of the caution speed range on an Air Speed Indicator, and what must the pilot be mindful of when operating in this range?",
    answers: [
  ...
  {
    question:
      "82. What V speed is it important not to exceed if sudden full-pitch, nose-up, control movements are planned, and why?",
    answers: [
  ...
  {
    question:
      "83. Which forward speed is normally maintained, following an engine failure in flight in a light airplane?",
    answers: [
      "Best glide speed.",
  ...
  {
    question:
      "84. At takeoff from a short airfield with an airplane or a powered hang glider, which airspeed should you fly until cleared of obstacles?",
    answers: [
  ...
  {
    question:
      "85. Which combination of atmospheric conditions will reduce aircraft takeoff and climb performance?",
    answers: [
  ...
  {
    question:
      "86. The aircraft's climb angle during a steady climb depends on.",
    answers: ["Excess of thrust.", "Power available.", "Thrust required."],
    correct: 0,
  },
  {
    question:
      "87. What influence does the wind have on an airplane's angle-of-climb?",
    answers: [
  ...
  {
    question:
      "88. What is the influence of the wind on an aeroplane's rate of climb?",
    answers: [
      "No effect.",
  ...
  {
    question:
      "89. What is the proper use for the best-rate-of-climb speed (Vy)?",
    answers: [
  ...
  {
    question:
      "90. After takeoff, which airspeed would the pilot use to gain the most altitude in a given period of time?",
    answers: [
      "Best climb speed (Vy).",
      "Best angle-of-climb speed (Vx).",
      "Maneuvering speed (VA).",
  ...
  {
    question:
      "91. The aircraft's rate-of-climb during a steady climb depends on.",
    answers: ["Excess of power.", "Excess of thrust.", "Thrust available."],
    correct: 0,
  },
  {
    question:
  ...
  {
    question:
      "93. The airplane's or powered hang glider's best angle-of-climb speed (Vx) is used.",
    answers: [
      "When clearing an obstacle.",
  ...
  {
    question:
      "94. What effect does high density altitude have on aircraft performance?",
    answers: [
  ...
  {
    question:
      "95. What effect does an uphill runway slope have on takeoff performance?",
    answers: [
  ...
  {
    question:
      "96. What influence does the increased mass have on powered aircraft takeoff performance?",
    answers: [
  ...
  {
    question:
      "97. In which Category. Utility or Normal, would you expect to operate the aircraft represented in the attached CG /Moment Envelope if its mass is 2100 lbs and its CG Moment 90,000 lb inches? (See fig. PPL FPP-7).",
    answers: ["Normal.", "Utility.", "Both.", "Neither."],
    correct: 0,
  },
  {
    question:
      "98. What is used as the aircraft reference for the CG limit, and upon which axis is that limit found? Axis / Reference.",
    answers: [
      "Longitudinal / Datum.",
      "Normal / Spinner.",
      "Lateral / Tail.",
  ...
  {
    question:
      '100. What does "Best Endurance Speed" for a propeller aircraft mean?',
    answers: [
  ...
  {
    question:
      "101. During landing on an airport with high elevation the true air speed (TAS) of an aircraft is higher than normal. What indicated speed (IAS) should be kept in such cases?",
    answers: [
      "Normal speed.",
      "Lower than normal.",
      "Higher than normal.",
  ...
  {
    question:
      "102. How will higher altitude affect the cruising indicated airspeed of an aircraft if a throttle remains unchanged?",
    answers: [
      "It will be lower.",
      "It will be higher.",
  ...
  {
    question:
      "103. Maneuvering speed (VA) is the highest speed at which even full abrupt deflection of the elevator will not exceed.",
    answers: [
  ...
  },
  {
    ...
    answers: ["Airspeed.", "Altitude.", "Angle of attack."],
    correct: 0,
  },
  {
  ...
  {
    question:
      "107. Maximum structural cruising speed is the maximum speed at which an airplane can be operated.",
    answers: [
      "In smooth air.",
  ...
  {
    question:
      "108. Should you use the normal approach speed when approaching to land in gusty wind conditions?",
    answers: [
  ...
  {
    question:
      "110. Determine the maximum wind velocity for a 30° crosswind if the maximum crosswind component for the airplane is 10 kts? (See fig. PPL FPP-13e).",
    answers: ["20 kts.", "13 kts.", "16 kts.", "18 kts."],
    correct: 0,
  },
  {
    question:
      "111. Determine the maximum wind velocity for a 40° crosswind if the maximum crosswind component for the airplane is 10 kts? (See fig. PPL FPP-13e).",
    answers: ["15 kts.", "20 kts.", "18 kts.", "12 kts."],
    correct: 0,
  },
  {
    question:
      "112. Determine the maximum wind velocity for a 45° crosswind if the maximum crosswind component for the airplane is 25 kts? (See fig. PPL FPP-13e).",
    answers: ["35 kts.", "18 kts.", "25 kts.", "29 kts."],
    correct: 0,
  },
  {
    question:
      "113. What are the headwind and crosswind components with the reported wind of 280°/15 kts for a runway with the magnetic direction 220°? (See fig. PPL FPP-13e).",
    answers: [
  ...
  {
    question:
      "114. Which runway (06, 14, 24, 32) will you choose for landing, if tower reports south wind 20 kts and if maximum allowed crosswind component for your aircraft is 13 kts? (See fig. PPL FPP-13e).",
    answers: ["RWY 14.", "RWY 06.", "RWY 24.", "RWY 32."],
    correct: 0,
  },
  {
    question:
      "115. What is the crosswind component for a landing on Runway 18 if the tower reports the wind as 220°/30 kts? (See fig. PPL FPP-13e).",
    answers: ["19 kts.", "23 kts.", "30 kts.", "34 kts."],
    correct: 0,
  },
  {
    question:
      "116. What are the headwind and crosswind components with the reported wind of 130°/20 kts for a runway with the magnetic direction 040°? (See fig. PPL FPP-13e).",
    answers: [
  ...
  {
    question:
      "117. What is the expected fuel consumption for a 250-nautical flight under the following conditions? (See fig. PPL FPP-14e) pressure altitude - 6,000 ft temperature - 20°C above standard power setting - 60% wind - calm.",
    answers: [
      "15.1 USA gal.",
      "19.7 USA gal.",
      "16.0 USA gal.",
  ...
  {
    question:
      "118. What is the expected fuel consumption for a 350-nautical flight under the following conditions? (See fig. PPL FPP-14e) pressure altitude - 4,000 ft temperature - 20°C below standard power setting - 60% wind - calm.",
    answers: [
      "22.7 USA gal.",
      "14.9 USA gal.",
      "15.3 USA gal.",
  ...
  {
    question:
      "119. What is the expected fuel consumption under the following conditions? (See fig. PPL FPP-14e) pressure altitude - 8,000 ft temperature - 20°C below standard power setting - 55%.",
    answers: [
      "6.2 USA gal/h.",
      "5.7 USA gal/h.",
      "5.8 USA gal/h.",
  ...
  {
    question:
      "120. Approximately what engine RPM should be set during cruising at the pressure altitude 2,000 ft and with standard temperature in order to develop 60% of power? (See fig. PPL FPP-14e).",
    answers: ["2300 RPM.", "2500 RPM.", "2400 RPM.", "2200 RPM."],
    correct: 0,
  },
  {
    question:
      "121. Determine the total distance required to land. (See fig. PPL FPP-16e) pressure altitude - 1,000 ft temperature - 30°C mass - 2300 lb wind - head 9 kt surface - tarmac.",
    answers: ["1197 ft.", "1330 ft.", "565 ft.", "509 ft."],
    correct: 0,
  },
  {
    question:
      "122. Determine the ground roll distance after landing. (See fig. PPL FPP-16e) pressure altitude - 3,000 ft temperature - 20°C mass - 2200 lb wind - calm surface - grass, dry.",
    answers: ["855 ft.", "590 ft.", "660 ft.", "685 ft."],
    correct: 0,
  },
  {
    question:
      "123. Determine the ground roll distance after landing. (See fig. PPL FPP-16e) pressure altitude - 0 ft temperature - 15°C mass - 2300 lb wind - calm surface - tarmac.",
    answers: ["520 ft.", "510 ft.", "530 ft.", "545 ft."],
    correct: 0,
  },
  {
    question:
      "124. Determine the total distance over a 50-foot obstacle required to land. (See fig. PPL FPP-16e) pressure altitude - 0 ft temperature - 0°C mass - 2300 lb wind - head 18 kt surface - grass, dry.",
    answers: ["1,140 ft.", "965 ft.", "1,205 ft.", "1,445 ft."],
    correct: 0,
  },
  {
    question:
      "125. Determine the density altitude of an airport for these conditions: QNH - 1010 hPa temperature - 27°C elevation - 5,250 ft.",
    answers: ["7,890 ft.", "4,600 ft.", "5,875 ft.", "8,800 ft."],
    correct: 0,
  },
  {
    question:
      "126. Determine the pressure altitude with an indicated altitude 1,380 ft with an altimeter setting of 1013.2 hPa at standard temperature.",
    answers: ["1,380 ft.", "1,280 ft.", "1,480 ft.", "1,580 ft."],
    correct: 0,
  },
  {
    question:
      "127. Calculate the rate of climb for an aircraft operating at 5000ft with an outside air temperature of 0°C. (See fig. PPL FPP-8e).",
    answers: ["530 fpm.", "585 fpm.", "475 fpm.", "470 fpm."],
    correct: 0,
  },
  {
    question:
      "128. What is the maximum amount of baggage that may be loaded aboard the normal category airplane for CG to remain inside proper limits? (See fig. PPL FPP-17H)",
    answers: ["105 lbs.", "120 lbs.", "90 lbs.", "75 lbs."],
    correct: 0,
  },
  {
    question:
      "129. Determine the moment with the following data: (See fig. PPL FPP-17G)",
    answers: ["74.9 lbxin.", "38.7 lbxin.", "69.9 lbxin.", "77.0 lbxin."],
    correct: 0,
  },
  {
    question:
      "130. What is the maximum amount of fuel that may be aboard the airplane on takeoff if loaded as follows? (See fig. PPL FPP-17F)",
    answers: ["40 USA gal.", "24 USA gal.", "34 USA gal.", "46 USA gal."],
    correct: 0,
  },
  {
    question:
      "131. An aircraft cruising at 2000ft is cleared to climb to 8000ft. Calculate the time taken in minutes, the fuel used in gallons and the distance flown during the climb. The temperature is standard and the wind is calm. (See fig. PPL FPP-9e) Time (mins) / Fuel (gal) / Distance (nm).",
    answers: [
      "12 / 2.3 / 17.",
      "15 / 3.0 / 21.",
      "3 / 0.7 / 4.",
  ...
  {
    question:
      "132. Your aircraft has:- A Take-off Mass of = 2353 tbs A calculated CG for departure = 89.75 inches aft of the datum An estimated fuel burn = 200 lbs with a CG 85.00 inches aft of datum. The position of the CG on landing will be?",
    answers: [
  ...
  {
    question:
      "133. With the reported wind of 360°/20 kts you are approaching an airport. Which runway (06,14 or 24) would you choose for landing, if your airplane had a 13-knots maximum allowed crosswind component on landing? (See fig. PPL FPP-13e).",
    answers: ["RWY 32.", "RWY 06.", "RWY 14.", "RWY 24."],
    correct: 0,
  },
  {
    question:
      "134. Determine the takeoff distance over a 50-foot obstacle under the following conditions: (See fig. PPL FPP-15e) pressure altitude - 0 ft temperature - standard mass - 1900 lb wind - calm surface - grass, dry.",
    answers: ["1,030 ft.", "920 ft.", "950 ft.", "1,180 ft."],
    correct: 0,
  },
  {
    question:
      "135. What will be the airspeed of an airplane in level flight under the following conditions? (See fig. PPL FPP-14e) pressure altitude - 8,000 ft temperature - 20°C below standard power setting - 55%.",
    answers: ["104 kts.", "110 kts.", "115 kts.", "120 kts."],
    correct: 0,
  },
  {
    question:
      "136. What is the headwind component for a landing on Runway 18 if the tower reports the wind as 220°/30 kts? (See fig. PPL FPP-13e).",
    answers: ["23 kts.", "19 kts.", "30 kts.", "34 kts."],
    correct: 0,
  },
  {
    question:
      "137. What are the headwind and crosswind components with the reported wind of 030°/10 kts for a runway with the magnetic direction 330°? (See fig. PPL FPP-13e).",
    answers: [
  ...
  {
    question:
      "138. Determine the density altitude of an airport for these conditions: QNH - 1025 hPa temperature - -4°C elevation - 3,850 ft.",
    answers: ["2,050 ft.", "2,900 ft.", "3,500 ft.", "3,800 ft."],
    correct: 0,
  },
  {
    question:
      "139. Determine the ground roll distance after landing. (See fig. PPL FPP-16e) pressure altitude - 0 ft temperature - 10°C mass - 2300 lb wind - head 10 kt surface - grass, dry.",
    answers: ["739 ft.", "510 ft.", "1235 ft.", "1790 ft."],
    correct: 0,
  },
  {
    question:
      "140. Determine the total distance over a 50-foot obstacle required to land. (See fig. PPL FPP-16e) pressure altitude - 1,500 ft temperature - 30°C mass - 2300 lb wind - calm surface - tarmac.",
    answers: ["1,350 ft.", "1,385 ft.", "1,320 ft.", "1,280 ft."],
    correct: 0,
  },
  {
    question:
      "141. Determine the total distance over a 50-foot obstacle required to land. (See fig. PPL FPP-16e) pressure altitude - 1,000 ft temperature - 10°C mass - 2300 lb wind - tail 10 kt surface -tarmac.",
    answers: ["1,900 ft.", "1,265 ft.", "1,360 ft.", "1,850 ft."],
    correct: 0,
  },
  {
    question:
      "142. Determine the ground roll distance required for takeoff! (See fig. PPL FPP-15e) pressure altitude - 2,000 ft temperature - 40°C mass - 2100 lb wind - tail 4 kt surface - tarmac.",
    answers: ["1,120 ft.", "565 ft.", "850 ft.", "935 ft."],
    correct: 0,
  },
  {
    question:
      "143. Determine the takeoff distance over a 50-foot obstacle under the following conditions: (See fig. PPL FPP-15e) pressure altitude - 2,000 ft temperature - 30°C mass - 2100 lb wind - head 18 kt surface - grass, dry.",
    answers: ["1,350 ft.", "1,555 ft.", "1,565 ft.", "2,945 ft."],
    correct: 0,
  },
  {
    question:
      "144. Determine approximately density altitude of an airport, where the temperature is standard and an altimeter set to 1011hPa, reads 1,300",
    answers: ["1,360 ft.", "1,240 ft.", "1,300 ft.", "1,400 ft."],
    correct: 0,
  },
  {
    question:
      "145. What is increase in density altitude if a temperature increases from 0 to 10°C and if the pressure altitude of an airport remains 3,000 ft?",
    answers: ["1,200 ft.", "3,000 ft.", "2,200 ft.", "2,000 ft."],
    correct: 0,
  },
  {
    question:
      "146. What is the effect of a temperature increase of 12°C on the density altitude?",
    answers: [
      "1,440-foot increase.",
      "1,650-foot decrease.",
      "1,340-foot decrease.",
  ...
  {
    question:
      "147. What is the approximate pressure altitude if an altimeter is set to 1010 hPa and indicates 1,380 ft?",
    answers: ["1,470 ft.", "1,200 ft.", "1,300 ft.", "1,400 ft."],
    correct: 0,
  },
  {
    question:
      "148. Determine the takeoff distance over a 50-foot obstacle under the following conditions: (See fig. PPL FPP-15e) pressure altitude - 4,000 ft temperature - 15°C mass - 2300 lb wind - calm surface - asphalt.",
    answers: ["2,100 ft.", "1,125 ft.", "1,210 ft.", "1,970 ft."],
    correct: 0,
  },
]; // Total questions: 148
