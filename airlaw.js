const AIRLAW_QUESTIONS = [
  ...
  {
    question:
      "2. The pilot in command of an aircraft which enters the sovereign airspace of another contracting state for the purpose of landing must:",
    answers: [
  ...
  {
    question:
      "3. Which body is responsible for ensuring that an aircraft operating in a state's sovereign airspace complies with the rules and regulations which prevail in that airspace?",
    answers: [
  ...
  {
    question:
      "4. The Rules of the Air applicable to an aircraft registered in one state flying over another state shall be:",
    answers: [
  ...
  {
    question:
      "5. While flying at night, as the pilot in command, you see an anti-collision light and a steady red light at the same altitude, at a constant relative bearing of 050 degrees, there a risk of collision? And who has right of way?",
    answers: [
  ...
  {
    question:
      "6. Two aircraft flying according to the Visual Flight Rules, one of which is receiving a Radar Information Service (RIS), are closing at an apparent constant relative bearing. There is, thus, a high risk of collision. The fact that one aircraft is receiving an RIS is immaterial to the situation. The Rules of the Air apply. Therefore, the aircraft which has the other on its left has right of way and should maintain:",
    answers: ["Course and speed.", "Height and speed.", "Altitude and course."],
    correct: 0,
  },
  {
    question:
      "7. When an aircraft is flying, under which flight rules must the flight be conducted?",
    answers: [
      "Either IFR or VFR.",
  ...
  {
    question:
      "9. What word is used to describe the vertical position of an aircraft measured above mean sea level, when QNH is set on the altimeter subscale?",
    answers: ["Altitude.", "Elevation.", "Height"],
    correct: 0,
  },
  {
    question:
      "10. What action should a pilot take if he suffers radio communications failure during a VFR flight in VMC?",
    answers: [
  ...
  {
    question:
      "11. Which of the following flight levels would be suitable for an aircraft flying in accordance with the quadrantal rule and maintaining a magnetic track of 146 degrees?, ",
    answers: ["FL75.", "FL50.", "FL85."],
    correct: 0,
  },
  {
    question:
      "12. A pilot intending to land at a civil aerodrome should initiate his descent to below transition level with the altimeter subscale set to:",
    answers: ["QNH.", "QFE.", "QNE."],
    correct: 0,
  },
  {
    question:
      "13. You are on final approach and you see a steady red light from ATC. This means:",
    answers: [
  ...
  {
    question:
      "16. What is the meaning of a steady green light from ATC to an aircraft in the air?",
    answers: [
      "Clear to land.",
  ...
  {
    question:
      "17. If an aircraft marshaller holds his right arm down and repeatedly moves his left arm upward and backward it means:",
    answers: ["Turn left.", "Turn right.", "Keep moving ahead."],
    correct: 0,
  },
  {
    question:
      "18. A light aircraft is taking off behind a Heavy or Medium category aircraft. What period of separation is required?",
    answers: ["2 minutes.", "4 minutes.", "3 minutes."],
    correct: 0,
  },
  {
    question: "19. How often are Aeronautical Information Circulars published?",
    answers: ["Monthly", "Weekly", "Yearly."],
    correct: 0,
  },
  {
    question:
      "20. What is the international Aeronautical VHF Distress Frequency?",
    answers: ["121.50 MHz", "123.45 MHz", "243.00 MHz"],
    correct: 0,
  },
  {
    question: "21. What SSR squawk should be set in an emergency?",
    answers: ["7700", "7600", "7500"],
    correct: 0,
  },
  {
  ...
  {
    question:
      "23. What word is used to describe the vertical position of an aircraft measured above an airfield datum level, when QFE is set on the altimeter subscale?",
    answers: ["Height", "Elevation.", "Altitude."],
    correct: 0,
  },
  {
    question:
      "24. Who is responsible for the issue of a Certificate of Airworthiness?",
    answers: [
  ...
  {
    question:
      "25. Which of the following normally defines 'runway in use' on an uncontrolled airfield?",
    answers: [
      "A runway into wind.",
  ...
  {
    question:
      "26. If the holder of a pilot's licence learns that he is to undergo surgery, what are his obligations in terms of informing the aviation medical authority?",
    answers: [
  ...
  {
    question:
      "27. The successful completion of the theoretical knowledge examinations will be valid for the issue of a light aircraft pilot licence (LAPL), a private pilot licence (PPL), a sailplane pilot licence (SPL) or a balloon pilot licence (BPL), for a period of",
    answers: ["24 months", "12 months", "36 months", "48 months"],
    correct: 0,
  },
  {
    question:
      "28. Pilots are required to keep their safety belts and shoulder harnesses fastened during",
    answers: [
  ...
  {
    question:
      "29. Which best describes the flight conditions under which pilots are specifically required to keep their safety harness fastened?",
    answers: [
  ...
  {
    question:
      "30. With respect to passengers, what obligation, if any, does a pilot in command have concerning the use of seat belts?",
    answers: [
  ...
  {
    question:
      "31. The person directly responsible for the briefing of passengers for a flight is",
    answers: ["Pilot in command.", "Safety officer.", "Ground crew member."],
    correct: 0,
  },
  {
    question:
      '32. What should be entered into the "LEVEL" block of an ICAO VFR Flight Plan?',
    answers: [
  ...
  },
  {
    ...
    answers: ["Work in progress.", "With permission.", "With effect from."],
    correct: 0,
  },
  {
    question:
      "34. Who is responsible for the adequate safe separation between VFR flights in the air?",
    answers: [
  ...
  {
    question:
      "35. Which rules of the air apply to an aircraft registered in the Republic of Slovenia while flying outside the native aerospace?",
    answers: [
  ...
  {
    question:
      "36. What is the lateral dimension of the airspace at the inner side of the state border, where all aircraft need to obtain special permission for flying within it?",
    answers: ["5 nm.", "7 nm.", "9 nm."],
    correct: 0,
  },
  {
    question:
      "37. Which of the cruising flight level listed is appropriate for a VFR flight over 3,000 ft MSL, while maintaining true course 170° and if the local variation value is 20°W?",
    answers: ["FL 65.", "FL 55.", "FL 40."],
    correct: 0,
  },
  {
    question:
      "38. What action should the pilots of an airplane and a glider take if on a head-on collision course?",
    answers: [
  ...
  {
    question:
      "39. How often is a glider or an aeroplane state of airworthiness inspected by the authorized person?",
    answers: [
  ...
  {
    question:
      "40. Which minimum life-saving equipment is recommended to be on board of a non-commercial flight of a single-engined landplane when flying en route over water beyond gliding distance from the shore?",
    answers: [
  ...
  {
    question:
      "41. A night flying inside the territory of Republic Serbia is defined by the state regulations as a flying between",
    answers: [
  ...
  {
    question:
      "42. Which of the following statements, concerning heavier-than-air aircraft right-of-way during landing, is correct?",
    answers: [
  ...
  {
    question:
      "43. When approaching to land at an airport, without an operating control tower, in Class G airspace, the pilot should",
    answers: [
  ...
  {
    question:
      "44. Visual flying of aircraft in class G airspace at altitudes above 900 m (3,000 ft) MSL or 300 m (1,000 ft) from ground, whichever is higher, up to 3,050 m (10,000 ft), is permitted if the horizontal visibility is at least",
    answers: ["1.5 km.", "8 km.", "5 km."],
    correct: 0,
  },
  {
    question:
      "45. When flying visually in class G airspace at altitudes above 900 m (3,000 ft) MSL or 300 m (1,000 ft) from ground, whichever is higher, the, pilot of an aircraft must maintain the vertical separation from clouds at least",
    answers: ["300 m.", "100 m.", "150 m."],
    correct: 0,
  },
  {
    question:
      "46. When flying a sport aircraft above the territory of the Republic of Slovenia, supplemental oxygen shall be used at the altitude above mean sea level greater than",
    answers: ["4,000 m.", "3,600 m.", "3,800 m."],
    correct: 0,
  },
  {
    question:
      "47. Aircraft A with an ATC clearance is flying in VMC conditions within a control area. Aircraft B with no ATC clearance is approaching at approximately the same altitude and on a converging course. Which has the right of way?",
    answers: [
  ...
  {
    question:
      "48. With your aeroplane on an IFR flight in airspace class D, you receive a traffic information from ATC, that an helicopter on VFR flight is going to cross your flight path from right to left. Who has the right-of-way?",
    answers: [
  ...
  {
    question:
      "49. Which of the statements listed, concerning the right-of-way when two aircraft converge, but not head-on, is correct?",
    answers: [
  ...
  {
    question:
      "50. What should the glider pilot do, if on head-on collision course with the two-engined Cessna?",
    answers: [
  ...
  {
    question:
      "51. How long is the period before the expiry date of a single pilot single engine rating, during which a proficiency check for a revalidation may be done?",
    answers: ["3 months.", "15 days.", "1 month."],
    correct: 0,
  },
  {
    question:
      "52. In addition to other preflight actions for a VFR flight away from the vicinity of the departure airport, regulations specifically require the pilot in command to determine",
    answers: [
  ...
  {
    question:
      "53. In which of the following cases should the aviation medical certificate deem to be suspended?",
    answers: [
  ...
  {
    question:
      "54. How long are single pilot single engine class ratings valid?",
    answers: ["2 years.", "6 months.", "1 year."],
    correct: 0,
  },
  {
    question:
      "55. The validity of a pilot licence is determined by the validity of",
    answers: [
  ...
  {
    question:
      "56. Which preflight action is specifically required of the pilot prior to each flight?",
    answers: [
  ...
  {
    question:
      "57. Preflight action, as required for all flights away from the vicinity of an airport, shall include",
    answers: [
  ...
  {
    question:
      "58. How many hours of total flying hours, required for the practical skill test for an issue of a Private Pilot Licence, may be completed on a Flight & Navigation Procedures Trainer or Simulator?",
    answers: ["5", "7", "10"],
    correct: 0,
  },
  {
    question:
      "59. At least how long must be the cross-country flight, required for the eligibility for the Private Pilot Licence skill test, and how many full stop landings at different aerodromes shall be made at this flight?",
    answers: [
      "150 NM; 2 landings.",
      "100 NM; 2 landings.",
      "200 NM; landings.",
  ...
  {
    question:
      "60. At least how many hours of flying experience as a pilot of airplanes must have an applicant for a Private Pilot Licence?",
    answers: ["45 hours.", "50 hours.", "40 hours."],
    correct: 0,
  },
  {
  ...
  {
    question:
      "62. The pilot or student pilot, when becoming aware of hospital admission of more than 12 hours, surgical operation or invasive procedure, the regular use of medication, the regular use of correcting lenses,",
    answers: [
  ...
  {
    question:
      "64. What action should be taken if a pilot receives a clearance that will cause a deviation from a rule?",
    answers: [
  ...
  {
    question:
      "65. If a pilot has to deviate from an air traffic control clearance due to unforseen circumstances, he has to",
    answers: [
  ...
  {
    question:
      "66. When intercepted by a military aircraft, the pilot of an VFR aircraft should",
    answers: [
      "Squawk 7700.",
  ...
  {
    question:
      "67. As a substitute for the proficiency check with an examiner, what minimum flight time and what number of takeoffs and landing is required for the revalidation of a single pilot single engine airplane class rating?",
    answers: [
  ...
  {
    question:
      "68. Flight time during which the flight instructor will only observe the student acting as pilot-in- command and shall not influence or control the flight of the aircraft is",
    answers: [
  ...
  {
    question:
      "70. To act as pilot in command of an airplane carrying passengers, the holder of PPL(A) must have made at least three takeoffs and three landings in an airplane of the same class, and if a type rating is required, of the same type, within the preceding",
    answers: ["90 days.", "12 calendar months.", "24 calendar months."],
    correct: 0,
  },
  {
    question:
      "71. At least how many hours of dual instructions on aeroplane must have an applicant for a PPL (A)?",
    answers: ["25 hours.", "10 hours.", "15 hours."],
    correct: 0,
  },
  {
  ...
  {
    question:
      "73. What Medical Certificate is required for a holder of a PPL(A),PPL(H),BPL and SPL?",
    answers: [
      "Class 1 or Class 2 Medical Certificate.",
      "Class 1 Medical Certificate only.",
      "Class A or Class B Medical Certificate",
  ...
  },
  {
    ...
    answers: ["17 years old.", "15 years old.", "16 years old."],
    correct: 0,
  },
  {
    question: "75. How long is an Instrument Rating valid for?",
    answers: ["12 months.", "6 months.", "18 months."],
    correct: 0,
  },
  {
    question:
      "76. Who is responsible for ensuring that all relevant aircraft documentation is carried on an international flight?",
    answers: [
  ...
  {
    question:
      "77. During a cross-country flight you find yourself in the vicinity of an unknown airport. A military aircraft approaches, turns around your aircraft, rocks the wings and finally lowers the landing gear. What does this mean?",
    answers: [
  ...
  {
    question:
      "78. During a cross-country flight you notice the military aircraft approaching your left wingtip and flying along; after a short time it makes an abrupt break-away maneuver of a climbing turn to the left. What does this mean?",
    answers: [
      "You may proceed!",
  ...
  {
    question:
      "79. Requested national mark of an aircraft registered in the Republic of Serbia is",
    answers: [
